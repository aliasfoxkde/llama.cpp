...
| Nomic-embed-text-v1.5-ONNX | 522MB | ~105ms | ~3665ms | 768 |
...
- Nomic ONNX: larger model (768 dim) ~5x slower than BGE
- GGUF embeddings are quantized (Q4_K_M) and much smaller (29MB vs 127MB)
...
**Recommendations:**
- **Speed priority**: BGE-small-en-v1.5 ONNX (fastest)
- **Quality/size priority**: Nomic-embed-text ONNX (768 dim, larger)
- **Storage constrained**: BGE Q4_K_M GGUF (29MB, portable)
